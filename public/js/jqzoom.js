(function ($) {
  $.fn.jqueryzoom = function (options) {
    ...
    $(this).hover(function () {
      ...
      var imageOffsetWidth = $(this).get(0).offsetWidth
      ...
      if (settings.position == "right") {
        leftpos = imageLeft + imageOffsetWidth + settings.offset
      } else {
        // 在左边
      ...
      $(document.body).mousemove(function (e) {
        ...
        var scrollyMax = imageHeight - $("span.zxx_image_zoom_div").height()/scaley
        ...
        var scrollxMax = imageWidth - ($("span.zxx_image_zoom_div").width()/scalex)
